...
class Tests:
    def test_bark(self, capsys, monkeypatch):
        ...
        cases = [
            {
                "inputs": ["Gustav", "4", "Schnauzer"],
                "expected": 'Gustav, the 4 year old Schnauzer, says, "Woof!"',
            },
            {
                "inputs": ["sport", "1", "terrier"],
                "expected": 'Sport, the 1 year old Terrier, says, "Woof!"',
            },
            {
                "inputs": ["FAUSTA", "66", "POODLE"],
                "expected": 'Fausta, the 66 year old Poodle, says, "Woof!"',
            },
            {
                "inputs": [random1, random2, random3],
                "expected": random1
                + ", the "
                + random2
                + " year old "
    ...
    def test_bark_with_validation(self, capsys, monkeypatch):
        ...
        cases = [
            ...
            {
                "inputs": ["FAUSTA", "15", "POODLE"],
                "expected": 'Fausta, the 15 year old Poodle, says, "Woof!"',
            },
            {
                "inputs": ["Gustav" + random1, random2, "Terrier" + random3],
                "expected": "Name error!",
            },
    ...
    def test_respond_to_anything(self, capsys, monkeypatch):
        ...
        cases = [
            {
                "inputs": ["Hello, are you well?"],
                "expected": "I'm sorry, I don't know.",
            },
            ...
            {
                "inputs": ["Hello, you are well"],
                "expected": "Please include a punctuation mark at the end of your sentence!",
            },
            {
                "inputs": ["That's your name"],
                "expected": "Please include a punctuation mark at the end of your sentence!",
            },
        ]
        for case in cases:
