...
class Tests:
    ...
    def test_get_guess(self, monkeypatch):
        ...
        for case in cases:
            ...
            monkeypatch.setattr(
                "problem_set_3.get_random_int", lambda x, y: mock_rand(x, y)
            )
    ...
    def test_play_game(self, capsys, monkeypatch):
        ...
        cases = [
            {
                "get_guess": [True, True, True, True],
                "expected": "Correct!\nCorrect!\nCorrect!\nCorrect!\nYou guessed 100% of the random numbers correctly.",
            },
            {
                "get_guess": [True, False, True, False],
                "expected": "Correct!\nWrong!\nCorrect!\nWrong!\nYou guessed 50% of the random numbers correctly.",
            },
            {
                "get_guess": [False, True, False, True],
                "expected": "Wrong!\nCorrect!\nWrong!\nCorrect!\nYou guessed 50% of the random numbers correctly.",
            },
            {
                "get_guess": [False, True, True, True],
                "expected": "Wrong!\nCorrect!\nCorrect!\nCorrect!\nYou guessed 75% of the random numbers correctly.",
            },
            {
                "get_guess": [False, True, False, False],
                "expected": "Wrong!\nCorrect!\nWrong!\nWrong!\nYou guessed 25% of the random numbers correctly.",
            },
            {
                "get_guess": [False, False, False, False],
            ...
            {
                "get_guess": [True, False, -1],
                "expected": "Correct!\nWrong!\nInvalid response!",
            },
            {
                "get_guess": [False, True, -1],
                "expected": "Wrong!\nCorrect!\nInvalid response!",
            },
            {
                "get_guess": [True, False, True, -1],
                "expected": "Correct!\nWrong!\nCorrect!\nInvalid response!",
            },
            {
                "get_guess": [False, True, False, -1],
                "expected": "Wrong!\nCorrect!\nWrong!\nInvalid response!",
            },
        ]
